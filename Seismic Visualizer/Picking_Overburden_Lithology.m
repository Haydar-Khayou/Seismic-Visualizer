function Picking_Overburden_Lithology(handles)
...
if handles.OB_Carbonate_OpenMineralogyButton.Value
    setappdata(handles.Model_fig, ['OB_Carbonate_Minerals' 'Entity' Entity_Num], Chosen_Minerals);
    
    setappdata(handles.Model_fig, ['OB_Carbonate_Minerals_List_Density' 'Entity' Entity_Num], Minerals_List_Density);
    setappdata(handles.Model_fig, ['OB_Carbonate_Minerals_List_K_Modulus' 'Entity' Entity_Num], Minerals_List_K_Modulus);
    setappdata(handles.Model_fig, ['OB_Carbonate_Minerals_List_Mu_Modulus' 'Entity' Entity_Num], Minerals_List_Mu_Modulus);
...
elseif handles.OB_Clastic_OpenMineralogyButton.Value
    setappdata(handles.Model_fig, ['OB_Clastics_Minerals' 'Entity' Entity_Num], Chosen_Minerals);
    
    setappdata(handles.Model_fig, ['OB_Clastics_Minerals_List_Density' 'Entity' Entity_Num], Minerals_List_Density);
    setappdata(handles.Model_fig, ['OB_Clastics_Minerals_List_K_Modulus' 'Entity' Entity_Num], Minerals_List_K_Modulus);
    setappdata(handles.Model_fig, ['OB_Clastics_Minerals_List_Mu_Modulus' 'Entity' Entity_Num], Minerals_List_Mu_Modulus);
    if ~isempty(Minerals_List_Density)
        handles.OB_Clastic_ShowMineralogyList.Visible='On';
    else
        handles.OB_Clastic_ShowMineralogyList.Visible='Off';
    end
elseif handles.OB_Basalt_OpenMineralogyButton.Value
    setappdata(handles.Model_fig, ['OB_Basalt_Minerals' 'Entity' Entity_Num], Chosen_Minerals);
    
    setappdata(handles.Model_fig, ['OB_Basalt_Minerals_List_Density' 'Entity' Entity_Num], Minerals_List_Density);
    setappdata(handles.Model_fig, ['OB_Basalt_Minerals_List_K_Modulus' 'Entity' Entity_Num], Minerals_List_K_Modulus);
    setappdata(handles.Model_fig, ['OB_Basalt_Minerals_List_Mu_Modulus' 'Entity' Entity_Num], Minerals_List_Mu_Modulus);
    if ~isempty(Minerals_List_Density)
